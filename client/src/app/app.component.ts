...
export class AppComponent implements AfterViewInit {
  ...
  // -----------------------------------------------------------
  // Use sender initials to custom color their messages
  ...
  // ---------------------------------------------------------------------
  // Graphic trick to make the scroll of the interface a little bit smooth
  // without using any additional library.
  private scroll(): void {
    setTimeout(() => {
      this.scrollToBottom();
    }, 100);
